...
3. Sign up for required services:
   - Create a Moralis account at https://moralis.io/
   - Get your API key from the Moralis dashboard
   - Set up an email account for notifications (Gmail recommended)

4. Update the `.env` file with your credentials:
   - Replace `your-moralis-api-key` with your Moralis API key
   - Replace `your-email@gmail.com` with your email
   - Replace `your-app-specific-password` with your email app password
...
4. Ensure the `.env` file is in the project root directory
